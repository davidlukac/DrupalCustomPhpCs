<?php
/**
 * DrupalCustom_Sniffs_InfoFiles_RequiredSniff.
 *
 * PHP version 5
 *
 * @category PHP
 ...
 * @link     http://pear.php.net/package/PHP_CodeSniffer
 */
class DrupalCustom_Sniffs_InfoFiles_RequiredSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $info     = DrupalCustom_Sniffs_InfoFiles_ClassFilesSniff::drupalParseInfoFormat($contents);
        ...
        if (isset($info['core']) === false) {
            ...
            $ptr   = DrupalCustom_Sniffs_InfoFiles_ClassFilesSniff::getPtr('php', $info['php'], $phpcsFile);
