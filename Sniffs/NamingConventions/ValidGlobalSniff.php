<?php
/**
 * DrupalCustom_Sniffs_NamingConventions_ValidGlobalSniff.
 *
 * PHP version 5
 *
 * @category PHP
 ...
 * @link     http://pear.php.net/package/PHP_CodeSniffer
 */
class DrupalCustom_Sniffs_NamingConventions_ValidGlobalSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public $coreGlobals = array(
                           ...
                           '$db_type',
                           '$db_url',
                           '$DrupalCustom_hash_salt',
                           '$DrupalCustom_test_info',
                           '$element',
